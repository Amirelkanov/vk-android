...
fun AppDetailsContent(
    ...
    Column(modifier) {
        ...
        ScreenshotsList(
            // Фолбэк чисто чтобы блок скриншотов был - не хочется прям мощно переписывать материал с практики
            screenshotUrlList = appDetails.screenshotUrlList ?: listOf("1", "2", "3"),
